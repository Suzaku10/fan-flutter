  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                    ...
                    children: [
                      ...
                      AppTextField.defaults(
                        ...
                        secondaryLabel: InkWell(
                          onTap: () async {
                            await getIt<FirebaseAuth>().sendPasswordResetEmail(email: _emailController.text);
                          },
                      ...
                      AppButton.defaults(
                          ...
                          onPressed: () async {
                            var a = getIt<FirebaseAuth>().currentUser;
                            print('print => ${a?.emailVerified}');

                            await getIt<FirebaseAuth>().signOut();
                            var b = getIt<FirebaseAuth>().currentUser;
                            print('print => ${b?.emailVerified}');

                            if (_formKey.currentState!.validate()) {
                              final result = await getIt<FirebaseAuth>().signInWithEmailAndPassword(
        ...
        //       state.maybeMap(
        //         orElse: () {},
        //         loading: (_) => EasyLoading.show(maskType: EasyLoadingMaskType.clear),
        //         loginSuccess: (_) => context.router.replaceNamed(AppPages.roots),
        //         showMessage: (e) => EasyLoading.showError(e.reason),
        //       );
        //     },
        //     builder: (context, __) => SingleChildScrollView(
        //       child: Column(
        //         children: [
        //           const GreetingsWidget(),
        //           Padding(
        ...
        //             child: Column(
        //               children: [
        //                 AppTextField.defaults(controller: _emailController, label: I10n.current.email, hint: I10n.current.hint_email),
        //                 const SizedBox(height: 24),
        //                 AppTextField.defaults(
        //                   controller: _passwordController,
        //                   label: I10n.current.password,
        ...
        //                   secondaryLabel: InkWell(
        //                     onTap: () {},
        //                     child: Text(I10n.current.forgot_password_info, style: AppStyles.textSmNova.primary.semiBold),
        //                   ),
        //                   suffixIcon: Padding(
        //                     padding: const EdgeInsets.only(right: 16),
        //                     child: InkWell(
        ...
        //                             TextSpan(
        //                               text: I10n.current.register_now,
        //                               style: AppStyles.textSmNova.primary.semiBold,
        //                               recognizer: TapGestureRecognizer()..onTap = () => context.router.pushNamed(AppPages.register),
        //                             )
        //                           ],
        //                           style: AppStyles.textSmNova.neutral),
        //                     ),
        //                   ),
        //                 ),
        //                 const Align(
